...
INSERT INTO sys_script (id_, name_, script_, category_, memo_) VALUES ('20000000570001', '获取当前组织ID', 'import com.dstz.sys.util.ContextUtil;nnreturn ContextUtil.getCurrentGroupId();', '系统内置', '通过引入静态方法来调用系统脚本，这样不需要实现Iscript脚本 。');
...
INSERT INTO "SYS_WORKBENCH_LAYOUT" VALUES ('403344394377232385', '20000000570002', '22', '20', '3', 'default_layout', TO_TIMESTAMP(' 2018-10-04 15:05:58', 'YYYY-MM-DD HH24:MI:SS:'));
INSERT INTO "SYS_WORKBENCH_LAYOUT" VALUES ('403344401693409281', '10000047970167', '93', '504', '2', '1', TO_TIMESTAMP(' 2018-10-04 15:06:26', 'YYYY-MM-DD HH24:MI:SS:'));
