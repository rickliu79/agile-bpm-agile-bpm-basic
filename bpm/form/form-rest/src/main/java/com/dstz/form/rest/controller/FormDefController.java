...
import com.dstz.form.util.FormElementGenerator;
...
public class FormDefController extends BaseController<FormDef> {
	...
	@ResponseBody
	public Object boTreeData(HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	public void templateData(HttpServletRequest request, HttpServletResponse response) throws Exception {
		String boKey = RequestUtil.getString(request, "boKey");
		writeSuccessData(response, formTemplateManager.templateData(boKey));
	}
	...
	public void createHtml(HttpServletRequest request, HttpServletResponse response, @RequestBody JSONArray jsonArray) throws Exception {
		...
		for (Object object : jsonArray) {
			...
			map.put("generator", FormElementGenerator.getInstance());
			String html ;
			try {
